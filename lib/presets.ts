...
export const PRESETS: Preset[] = [
  ...
  },
  {
    ...
    category: "add-sub",
    type: "base-ten",
    defaultTitle: "Two-Digit Subtraction with Base Ten Blocks",
    defaultInstructions: "Cross out blocks to subtract. Write the answer in the table.",
    config: { operations: ["subtract"] },
  },
  {
    id: "multi-digit",
